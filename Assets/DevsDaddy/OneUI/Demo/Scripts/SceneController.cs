...
namespace DevsDaddy.OneUI.Demo
{
    ...
    internal class SceneController : MonoBehaviour
    {
        ...
        private void BindViews() {
            UIFramework.BindView(FindAnyObjectByType<WelcomeView>());
            UIFramework.BindView(FindAnyObjectByType<HomeView>());
            UIFramework.BindView(FindAnyObjectByType<MoreMenuView>());
        }
    }
}
